 OWASP topic includes details on what the vulnerability is, how it occurs and how you can exploit it:  
- Injection
...
- **Reflected XSS**
When you submit anything in the search input, it will appear in the keyword query in your URL. Remember, the main difference between reflected and dom based xss, is that with reflected xss your payload (string in this case) gets inputted directly into the page. No Javascript is loaded before hand, neither is anything processed in the DOM before hand.
